...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table id="table-1"
                            ...
                            <thead>
                                ...
                                <th class="border-bottom-0" width="15%">Tanggal Keluar</th>
                                <th class="border-bottom-0" width="15%">Kode Barang Keluar</th>
                                <th class="border-bottom-0" width="10%">Kode Barang</th>
                                <th class="border-bottom-0" width="15%">Barang</th>
                                <th class="border-bottom-0" width="10%">Jumlah Keluar</th>
                                <th class="border-bottom-0" width="15%">Tujuan</th>
    ...
    <script>
        function generateID() {
            ...
            var uniqueId = Math.floor(Math.random() * 10000000000); // Nomor acak 10 digit
